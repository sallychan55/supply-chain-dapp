...
contract('SupplyChain', function(accounts) {
    ...
    //const balance = web3.toWei(".05", "ether");
    var itemState = 0
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        assert.equal(resultBufferOne[2], originFarmerID, 'Error: Missing or Invalid originFarmID') 
        assert.equal(resultBufferTwo[5].toString(), "1", 'Error: Invalid item State')
        assert.equal(eventEmitted, true, 'Invalid event emitted') 
    })    

    // 3rd Test for paclItem()
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5].toString(), "3", 'Error: Invalid item State')
        assert.equal(eventEmitted, true, 'Invalid event emitted')   
    })    

    // 5th Test for buyItem()
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5].toString(), "4", 'Error: Invalid item State')
        assert.equal(eventEmitted, true, 'Invalid event emitted')   
    })    

    // 6th Test fo shipItem()
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        assert.equal(resultBufferOne[2], distributorID, 'Error: Missing or Invalid distributorID')
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Missing or Invalid distributorID')   
        assert.equal(resultBufferTwo[5].toString(), "5", 'Error: Invalid item State')
        assert.equal(eventEmitted, true, 'Invalid event emitted')         
    })    

    // 7th Test for receiveItem()
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[5].toString(), "6", 'Error: Invalid item State')
        assert.equal(eventEmitted, true, 'Invalid event emitted')       
    })    

    // 8th Test for purchaseItem()
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(resultBufferTwo[5].toString(), "7", 'Error: Invalid item State')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    })    

    // 9th Test for fetchItemBufferOne()
    ...
    // 10th Test for fetchItemBufferTwo()
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        assert.equal(resultBufferTwo[5].toString(), "7") 
